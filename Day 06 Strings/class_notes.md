...
```python
name = "Rajesh"
file_name = 'shot001.exr'
decription = """Multi-line String"""
```
...
used to access a single characters.
...
- Negative never gives an Index Error.
- Slicing never methods return a new Strings.
...
Strings are one of the most important data types in Python and are widely used in VFX, Animation, Automation, and Pipeline Development.